...
export default async function Page() {
  ...
  return (
    <div className="py-20 relative overflow-hidden" style={{ backgroundColor: '#152A20' }}>
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#1e3d2b] to-[#152A20] z-0"></div>
      <div className="absolute top-0 right-0 w-full h-40 bg-gradient-to-b from-emerald-900/20 to-transparent z-0"></div>
      <div className="absolute bottom-0 left-0 w-full h-40 bg-gradient-to-t from-emerald-900/20 to-transparent z-0"></div>

      <PageClient />
      <div className="container relative z-20 my-12 ">
