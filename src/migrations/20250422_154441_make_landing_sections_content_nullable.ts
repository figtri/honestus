...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`landing_sections_testimonials\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`quote\` text,
  	...
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`landing_sections\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`landing_sections_testimonials_order_idx\` ON \`landing_sections_testimonials\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_testimonials_parent_id_idx\` ON \`landing_sections_testimonials\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_testimonials_image_idx\` ON \`landing_sections_testimonials\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`landing_sections_articles\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`landing_sections_articles_order_idx\` ON \`landing_sections_articles\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_articles_parent_id_idx\` ON \`landing_sections_articles\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`landing_sections_spotify_urls\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`url\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`landing_sections_spotify_urls_order_idx\` ON \`landing_sections_spotify_urls\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_spotify_urls_parent_id_idx\` ON \`landing_sections_spotify_urls\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`landing_sections\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text NOT NULL,
  	\`type\` text NOT NULL,
  	\`content\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`landing_sections_image_idx\` ON \`landing_sections\` (\`image_id\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_updated_at_idx\` ON \`landing_sections\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_created_at_idx\` ON \`landing_sections\` (\`created_at\`);`)
  await db.run(sql`CREATE TABLE \`landing_sections_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	\`posts_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`landing_sections\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`posts_id\`) REFERENCES \`posts\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`landing_sections_rels_order_idx\` ON \`landing_sections_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_rels_parent_idx\` ON \`landing_sections_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_rels_path_idx\` ON \`landing_sections_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`landing_sections_rels_posts_id_idx\` ON \`landing_sections_rels\` (\`posts_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`payload_locked_documents_rels\` (
  	...
  	FOREIGN KEY (\`categories_id\`) REFERENCES \`categories\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`users_id\`) REFERENCES \`users\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`landing_sections_id\`) REFERENCES \`landing_sections\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_landing_sections_id_idx\` ON \`payload_locked_documents_rels\` (\`landing_sections_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`landing_sections_testimonials\`;`)
  await db.run(sql`DROP TABLE \`landing_sections_articles\`;`)
  await db.run(sql`DROP TABLE \`landing_sections_spotify_urls\`;`)
  await db.run(sql`DROP TABLE \`landing_sections\`;`)
  await db.run(sql`DROP TABLE \`landing_sections_rels\`;`)
